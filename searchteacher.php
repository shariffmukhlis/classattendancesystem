...
<?php 
    ...
    if(isset($_POST['submit'])){
        $search = $_POST['search'];
        $sql = "select a.*, b.CLASS_NAME from teacher a natural join class b where name like '%".$_POST['search']."%'";
                        ...
                        echo "
                            ...
                            while($rows = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>" .$rows['NOPHONE']. "</td>
                                    <td>" .$rows['SUBJECT']. "</td>
                                    <td> <a href='teacherupdate.php?teacherid=".$rows['TEACHER_ID']."'><span class='material-symbols-outlined'> edit </span></a></td>
                                    <td> <a href='deleteteacher.php?teacherid=".$rows['TEACHER_ID']."'><span class='material-symbols-outlined'> delete </span></a></td>
                                </tr>
                                ";
                            }
                        }
